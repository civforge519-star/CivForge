...
- Worker (set in Cloudflare or `.env` for wrangler):
  ...
  - `TICK_RATE` (default 1)
- Web (Pages env):
  - `VITE_WORKER_HTTP_URL=https://your-worker.your-domain.workers.dev`
  - `VITE_WORKER_WS_URL=wss://your-worker.your-domain.workers.dev/ws`
...
3. Add Pages environment variables:
   ...
   - `VITE_WORKER_WS_URL`
   - `VITE_ADMIN_TOKEN`
4. Deploy. The UI will connect to the Worker WebSocket.
